...
import { HistoryHosted, HistoryParticipated } from './pages/MyPage/History';
              ...
              <Route element={<LayoutComponent.Main />}>
                ...
                <Route element={<LayoutComponent.Layout headerType={'back'} navVisible={false} />}>
                  ...
                  <Route path={PATH.HISTORY} element={<MyPagePages.History />}>
                    <Route path={'hosted'} element={<HistoryHosted />} />
                    <Route path={'participated'} element={<HistoryParticipated />} />
                  </Route>
